...
// import 'dart:html';
import 'dart:convert';
import 'package:covid19/model.dart';
import 'package:covid19/note/main.dart';
import 'package:covid19/worlddata.dart';
    ...
    return DoubleBack(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Center(child: Text("Indonesia Covid19 data")),
          actions: [
            Container(
  ...
  Future getdatan() async {
    try {
      ...
      if (status == DataConnectionStatus.connected) {
        var uri =
            Uri.parse("https://disease.sh/v3/covid-19/countries/indonesia");
